          ...
          <div className="flex flex-col space-y-8 h-full">
            ...
            <div className="glass-dark rounded-2xl p-8 border border-white/5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <a href="#" className="flex flex-col items-center justify-center p-6 rounded-xl bg-slate-800/50 hover:bg-slate-800 border border-white/5 hover:border-blue-500/30 transition-all group">
                  <div className="w-12 h-12 rounded-full bg-[#97cbfb]/10 flex items-center justify-center text-[#2181f6] font-extrabold text-2xl mb-3 group-hover:scale-110 transition-transform">
                    А
                  </div>
                  <span className="text-white font-medium text-sm">Авито</span>
                </a>
