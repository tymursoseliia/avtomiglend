...
const teamMembers = [
  ...
  { id: 10, name: "Ожидает назначения", role: "Менеджер" },
  { id: 11, name: "Ожидает назначения", role: "Менеджер" },
  { id: 12, name: "Ожидает назначения", role: "Менеджер" },
  { id: 13, name: "Ожидает назначения", role: "Менеджер" },
  { id: 14, name: "Ожидает назначения", role: "Менеджер" },
  { id: 15, name: "Ожидает назначения", role: "Менеджер" },
  { id: 16, name: "Ожидает назначения", role: "Менеджер" },
];
